...
import IntegrationFor3rdPartyChatController, {
  Props,
  configJSON,
} from "./IntegrationFor3rdPartyChatController";

export default class IntegrationFor3rdPartyChat extends IntegrationFor3rdPartyChatController {
