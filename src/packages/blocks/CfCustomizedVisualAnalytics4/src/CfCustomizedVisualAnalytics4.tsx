...
import CfCustomizedVisualAnalytics4Controller, {
  Props,
  configJSON,
} from "./CfCustomizedVisualAnalytics4Controller";

export default class CfCustomizedVisualAnalytics4 extends CfCustomizedVisualAnalytics4Controller {
