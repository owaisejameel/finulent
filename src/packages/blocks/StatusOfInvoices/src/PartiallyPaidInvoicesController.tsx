...
export default class PartiallyPaidInvoicesController extends BlockComponent<
  Props,
  S,
  SS
> {
 ...
 updateUser = () => {
  ...
  async receive(from: string, message: Message) {
    ...
    if (getName(MessageEnum.RestAPIResponceMessage) === message.id) {
      ...
      this.roleApiCall(apiRequestCallId, responseJson, message)
  ...
  // Customizable Area Start
  roleApiCall=(apiRequestCallId:any, responseJson:any, message:any)=>{
