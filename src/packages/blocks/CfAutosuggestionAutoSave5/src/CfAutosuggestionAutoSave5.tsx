...
import CfAutosuggestionAutoSave5Controller, {
  Props,
  configJSON,
} from "./CfAutosuggestionAutoSave5Controller";

export default class CfAutosuggestionAutoSave5 extends CfAutosuggestionAutoSave5Controller {
