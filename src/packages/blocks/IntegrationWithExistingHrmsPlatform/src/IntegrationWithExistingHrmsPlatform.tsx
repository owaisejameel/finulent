...
import IntegrationWithExistingHrmsPlatformController, {
  Props,
  configJSON,
} from "./IntegrationWithExistingHrmsPlatformController";

export default class IntegrationWithExistingHrmsPlatform extends IntegrationWithExistingHrmsPlatformController {
