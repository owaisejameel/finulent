...
// }
handleClose = () => {
    this.setState({ genericModalOpen: false, designation:"",role:"" , joiningDate:null,workspace:"",page:true});
  };
  handleAction = () => {
                  ...
                  return (
                    <TableRow>
                      ...
                      {this.state.filterBy && this.state.filterBy === "Pending" ?
                         <TableCell className="tablebutton actiontable">
                         <Button className="btnAction" onClick={()=>this.handleAccept(item.id)}>Accept</Button>
                         <Button className="btnReject" onClick={()=>this.handleRejectConfirm(item.id)}>Reject</Button>
                       </TableCell>:<></>
                       }
