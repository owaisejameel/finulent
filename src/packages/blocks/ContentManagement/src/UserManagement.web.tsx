    ...
    return (
     ...
     />
      ...
      >
        ...
        <Link   href="" onClick={this.handleReset}  className="reset-btn">Clear Filter</Link>
        {/* <Link onClick={this.getUsers()}>  Reset</Link> */}
        </div>
        ...
        <Button  className="btn-addmenu" onClick={this.handleApply}>Apply</Button>
        </div>
