...
import CfTaskTrackManagementBoardController, {
  Props,
  configJSON,
} from "./CfTaskTrackManagementBoardController";

export default class CfTaskTrackManagementBoard extends CfTaskTrackManagementBoardController {
