...
import CfColorCodeAutomation4Controller, {
  Props,
  configJSON,
} from "./CfColorCodeAutomation4Controller";

export default class CfColorCodeAutomation4 extends CfColorCodeAutomation4Controller {
