...
import CfChecklistDefinition4Controller, {
  Props,
  configJSON,
} from "./CfChecklistDefinition4Controller";

export default class CfChecklistDefinition4 extends CfChecklistDefinition4Controller {
