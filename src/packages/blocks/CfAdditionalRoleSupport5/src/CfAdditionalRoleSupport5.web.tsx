...
import CfAdditionalRoleSupport5Controller, {
  Props,
  configJSON,
} from "./CfAdditionalRoleSupport5Controller";

export default class CfAdditionalRoleSupport5 extends CfAdditionalRoleSupport5Controller {
