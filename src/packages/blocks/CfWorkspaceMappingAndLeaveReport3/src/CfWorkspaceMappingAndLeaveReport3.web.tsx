...
import CfWorkspaceMappingAndLeaveReport3Controller, {
  Props,
  configJSON,
} from "./CfWorkspaceMappingAndLeaveReport3Controller";

export default class CfWorkspaceMappingAndLeaveReport3 extends CfWorkspaceMappingAndLeaveReport3Controller {
