...
import CfCustomizableFilterConditions4Controller, {
  Props,
  configJSON,
} from "./CfCustomizableFilterConditions4Controller";

export default class CfCustomizableFilterConditions4 extends CfCustomizableFilterConditions4Controller {
