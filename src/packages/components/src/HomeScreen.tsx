...
<CustomTextItem content={'KanbanBoard'}  onPress={() => navigation.navigate("KanbanBoard")} />
...
<CustomTextItem content={'IntegrationWithExistingHrmsPlatform'}  onPress={() => navigation.navigate("IntegrationWithExistingHrmsPlatform")} />
<CustomTextItem content={'EditInvoices'}  onPress={() => navigation.navigate("EditInvoices")} />
<CustomTextItem content={'StatusOfInvoices'}  onPress={() => navigation.navigate("StatusOfInvoices")} />
<CustomTextItem content={'IntegrationFor3rdPartyChat'}  onPress={() => navigation.navigate("IntegrationFor3rdPartyChat")} />
<CustomTextItem content={'Timestamp'}  onPress={() => navigation.navigate("Timestamp")} />
...
<CustomTextItem content={'Pagination2'}  onPress={() => navigation.navigate("Pagination2")} />
<CustomTextItem content={'CfCustomizedVisualAnalytics4'}  onPress={() => navigation.navigate("CfCustomizedVisualAnalytics4")} />
<CustomTextItem content={'CfChecklistDefinition4'}  onPress={() => navigation.navigate("CfChecklistDefinition4")} />
<CustomTextItem content={'CfColorCodeAutomation4'}  onPress={() => navigation.navigate("CfColorCodeAutomation4")} />
<CustomTextItem content={'CfCustomizableFilterConditions4'}  onPress={() => navigation.navigate("CfCustomizableFilterConditions4")} />
<CustomTextItem content={'CfAutosuggestionAutoSave5'}  onPress={() => navigation.navigate("CfAutosuggestionAutoSave5")} />
<CustomTextItem content={'CfAdditionalRoleSupport5'}  onPress={() => navigation.navigate("CfAdditionalRoleSupport5")} />

<CustomTextItem content={'CfTaskTrackManagementBoard'}  onPress={() => navigation.navigate("CfTaskTrackManagementBoard")} />

<CustomTextItem content={'CfWorkspaceMappingAndLeaveReport3'}  onPress={() => navigation.navigate("CfWorkspaceMappingAndLeaveReport3")} />
